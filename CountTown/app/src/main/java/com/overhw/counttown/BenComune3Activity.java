...
public class
BenComune3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DetailsEchoAppalti().execute("https://overhw.com/counttown/scripts/appalti_details_anno.php?ncomune=" + BenchmarkActivity.benComune3 + "&anno=" + spinner.getSelectedItem().toString());
            }
        });
    ...
    private void initData() {
        if(DatiComuni.dettagli_comune != null){
            citta.setText(BenchmarkActivity.benComune3);
        }
    }
    ...
    class DetailsEchoAppalti extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            pDialog = new ProgressDialog(BenComune3Activity.this);
