...
public class
BenComune4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new DetailsEchoAppalti().execute("https://overhw.com/counttown/scripts/appalti_details_anno.php?ncomune=" + BenchmarkActivity.benComune4 + "&anno=" + spinner.getSelectedItem().toString());
            }
        });
    ...
    private void initData() {
        if(DatiComuni.dettagli_comune != null){
            citta.setText(BenchmarkActivity.benComune4);
        }
    }
    ...
    class DetailsEchoAppalti extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            pDialog = new ProgressDialog(BenComune4Activity.this);
